...
- Use the words the game itself uses. Where Bannerlord names a thing on screen, the food variety morale bonus, a garrison, a caravan, write that name rather than a paraphrase of it, and write the entry the way one player would tell another what changed. A reader should never have to translate it back into the game's own terms.
