...
namespace TradeLord.Mcm
{
    ...
    public class Settings : AttributeGlobalSettings<Settings>
    {
        ...
        [SettingPropertyGroup("{=TL103}Selling", GroupOrder = 5)]
        public int KeepPerFoodKind { get => Options.Current.KeepPerFoodKind; set { Options.Current.KeepPerFoodKind = value; Options.Bump(); } }
        ...
        [SettingPropertyInteger("{=TL228}Sell loot up to tier (0 = off)", 0, 6, Order = 4, RequireRestart = false,
        ...
        [SettingPropertyBool("{=TL229}Hold cargo for the best market", Order = 5, RequireRestart = false,
        ...
        [SettingPropertyFloatingInteger("{=TL230}Best-market tolerance", 0.5f, 1f, "#0%", Order = 6, RequireRestart = false,
        ...
        [SettingPropertyText("{=TL231}Never sell (item ids or names, comma separated)", Order = 7, RequireRestart = false,
        ...
        [SettingPropertyText("{=TL232}Always sell (item ids or names, comma separated)", Order = 8, RequireRestart = false,
